...
$packageProjects = @(
    (Join-Path $repositoryRoot 'api/src/Concertable.Auth.Contracts/Concertable.Auth.Contracts.csproj'),
    (Join-Path $repositoryRoot 'api/src/Concertable.Auth.Hosting/Concertable.Auth.Hosting.csproj')
)
